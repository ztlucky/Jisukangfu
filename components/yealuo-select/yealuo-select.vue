<template>
	<view class="yealuo-select" :style="getStyle">
		...
		<view class="yealuo-con">
			<slot name='left'></slot>
			<input class="input" :disabled="theDisabled" :placeholder="placeholder" v-model="theValue" @input="theInput" @tap='isShow=data.length' @focus="theFocus" @blur="theBlur" autocomplete="off" />
