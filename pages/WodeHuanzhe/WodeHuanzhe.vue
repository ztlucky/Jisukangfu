...
<!-- 			//患者列表 -->
			...
			<view class="huanzheview" @click="huanzheXiangqing()" v-for="(item,index) in huanzhetongji" :key ='index'>
						...
						<view class="huanzherightview">
							<view class="firstView">
								<text class="name">刘胡兰</text>
													...
													<text class="chakanhuanzheview">查看患者</text>
						</view> 
				 	</view>
					<view class="Hlinew">
					 ...
					 <uni-grid :column="2"  :square="false"   :showBorder="false" @change="" :highlight="false">
					 	<uni-grid-item  v-for="(item ,index) in zhixing" :key ="index" :index= "index" >
