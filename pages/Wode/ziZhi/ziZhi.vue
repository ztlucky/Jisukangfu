<template>
	<view class="view">
		<nav-bar  bgColor="#ffffff" backState="1000" fontColor="#000000" title="资质" type="ordinary" >
			<view slot="right"  @click="save" class="navRight">完成</view>
		</nav-bar>
		<view class="top">
			<view class="tips">请上传你的资质…</view>
