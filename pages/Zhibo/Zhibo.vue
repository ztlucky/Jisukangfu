<template>
	<view class="page">
		...
		<scroll-view :scroll-y="true" class="mainscrollview" >
			<navigator :url="'/pages/Daxue/Zhibodetail/Zhibodetail?id=' + item.id" class="zhiboitem" v-for="(item, index) in liveList"
				...
				this.$app.request({
					...
					success: res => {
						...
						if (res.code == 200) {
							...
							console.log(that.category_index)
